...
import dev.mostlyharmless.malisisdoorsreborn.hbm.client.render.item.HbmWaterDoorItemRenderer;
...
public class HbmWaterDoorBlockItem extends TooltipBlockItem {
    ...
    public void initializeClient(@NotNull final Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private HbmWaterDoorItemRenderer renderer;

            @Override
            public @NotNull BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null) {
                    final Minecraft minecraft = Minecraft.getInstance();
                    renderer = new HbmWaterDoorItemRenderer(
