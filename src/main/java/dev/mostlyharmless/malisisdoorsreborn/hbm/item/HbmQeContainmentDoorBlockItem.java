...
public class HbmQeContainmentDoorBlockItem extends TooltipBlockItem {
    ...
    public void appendHoverText(@NotNull final ItemStack stack,
        ...
        consumer.accept(Component.translatable(
                "tooltip.malisisdoorsreborn.hbm_qe_containment_door.skin",
                Component.translatable("tooltip.malisisdoorsreborn.hbm_qe_containment_door.skin." + skinKey(skinIndexFromStack(stack)))
