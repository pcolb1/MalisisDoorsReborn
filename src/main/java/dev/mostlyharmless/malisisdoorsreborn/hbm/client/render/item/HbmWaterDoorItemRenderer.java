...
public class HbmWaterDoorItemRenderer implements SpecialModelRenderer<Integer> {

    public static final Identifier TYPE = Identifier.fromNamespaceAndPath(MdrDefaults.MOD_ID, "hbm_water_door");

    @Override
    public @Nullable Integer extractArgument(@NotNull final ItemStack stack) {
        return HbmWaterDoorBlockItem.skinIndexForRender(stack);
    }
    ...
    public void submit(@Nullable final Integer skinIndex,
        ...
        HbmWaterDoorBlockEntityRenderer.submitItem(poseStack, collector, packedLight, packedOverlay, skinIndex == null ? 0 : skinIndex);
    }
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        public SpecialModelRenderer<?> bake(@NotNull final SpecialModelRenderer.BakingContext context) {
            return new HbmWaterDoorItemRenderer();
        }
    }
}
